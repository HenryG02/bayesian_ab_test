...
## 1. Project Summary
This projects aims to apply Bayesian A/B testing to compare two versions of a fictional website, A and B, and determine which one is better.

## 2. Configuration
This projects uses uv as the dependency manager. To install dependencies, run the following command:
